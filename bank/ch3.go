...
**步骤 4 — 线性表示：** $\alpha_4$ 可由极大无关组 $\alpha_1,\alpha_2,\alpha_3$ 线性表示。第 7 空填被表示向量的下标（即 4），随后第 8、10、12 空依次为 $\alpha_1,\alpha_2,\alpha_3$ 的表示系数，第 9、11、13 空依次为对应的列标 1、2、3，于是
$$\alpha_4=({{Chapter3_11_8}})\alpha_1+({{Chapter3_11_10}})\alpha_2+({{Chapter3_11_12}})\alpha_3$$

**答案汇总：**
- 第 1 空（秩）：{{Chapter3_11_1}}
- 第 2 空（相关性）：{{Chapter3_11_2}}
- 第 3-6 空（极大无关组下标）：{{Chapter3_11_3}}, {{Chapter3_11_4}}, {{Chapter3_11_5}}, {{Chapter3_11_6}}
- 第 7 空（被表示向量下标）：{{Chapter3_11_7}}
- 第 8-13 空（系数与列标交替）：系数 {{Chapter3_11_8}}（列 {{Chapter3_11_9}}）、系数 {{Chapter3_11_10}}（列 {{Chapter3_11_11}}）、系数 {{Chapter3_11_12}}（列 {{Chapter3_11_13}}），即 $\alpha_4=({{Chapter3_11_8}})\alpha_1+({{Chapter3_11_10}})\alpha_2+({{Chapter3_11_12}})\alpha_3$
- 第 14-24 空：其余位置填 0。`,
		},
	}
}
